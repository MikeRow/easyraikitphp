<?php
	...
	*/
	...
	function rb_call_method($method,$params = null){
		...
		if( isset($result["balance"]) ){ $result["balance_rai"] = number_format($result["balance"]/RAIN,24,".",","); }
		if( isset($result["weight"]) ){ $result["weight_rai"] = number_format($result["weight"]/RAIN,24,".",","); }
